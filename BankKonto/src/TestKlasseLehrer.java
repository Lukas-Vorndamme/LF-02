public class TestKlasseLehrer {
    public static void main(String[] args){
        ...
        Sparkonto sparkonto1 = new Sparkonto(kunde1, 3.0,1.5);
        ...
        if (girokonto1.ueberweisung(2000,girokonto1)){
            System.out.println(girokonto2);
            System.out.println(girokonto1);
        }else {
        ...
        if (girokonto1.ueberweisung(100.0,girokonto1)){
